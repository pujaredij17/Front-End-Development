              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                   <ul class="nav navbar-nav navbar-right">
                       ...
                       <li><a href="buy-from-us.php">Comprar Boletos</a></li>
...
<div class="popup-header">
  ...
  <?php
      ...
      $sql = "INSERT INTO `event_individual` (`event_name`, `user_name`) VALUES ('Event1', '$current_user')";
 ...
 if (isset($_POST['confirm1'])){
      ...
      $sql = "INSERT INTO `event_individual` (`event_name`, `user_name`) VALUES ('Event2', '$current_user')";
 ...
 if (isset($_POST['confirm2'])){
      ...
      $sql = "INSERT INTO `event_individual` (`event_name`, `user_name`) VALUES ('Event3', '$current_user')";
