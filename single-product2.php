  ...
  //$product_name = $_POST['product_name'];
   ...
   //echo "$product_name";
    ...
    //echo "$current_user";
     ...
     $sql = "INSERT INTO `user_cart` (`name`, `product_name`, `quantity`,`price`) VALUES ('$current_user', 'LA IMPORTANCIA DE LOS ALIMENTOS', '$quantity','300*($quantity)')";
